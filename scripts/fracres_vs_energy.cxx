...
void fracres_vs_energy(){

// get file
TFile *f        = new TFile("/sbnd/app/users/tham/larsoft_energy_tech_note/root_files/electron_vertex_bnblike_cheat_plane2_ESTAR.root","read");
...
TH2D *h_frac_res_vs_hit_energy       = new TH2D("frac_res_vs_hit_energy","",100,0,1100,50,-1,1);
TH2D *h_frac_res_vs_showering_energy = new TH2D("frac_res_vs_showering_energy","",100,0,1100,50,-1,1);
...
// TLine at nominal (zero)
TLine *nom_line = new TLine(0,0,1100,0);
...
h_frac_res_vs_hit_energy->ProfileX("a",1,-1,"s")->GetYaxis()->SetRangeUser(-0.2,0.2);
...
h_frac_res_vs_showering_energy->ProfileX("b",1,-1,"s")->GetYaxis()->SetRangeUser(-1,0.2);
